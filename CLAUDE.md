...
│   ├── mcp-tools.ts             ← MCP tool definitions (9 tools: retain/recall/reflect/extract/forget/supersede/session/queue_stats/requeue_failed)
